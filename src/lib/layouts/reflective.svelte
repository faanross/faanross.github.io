...
<article class="lesson">
	<div class="lesson-header">
		<a href="/courses/reflective" class="back-link">
...
<style>
	...
	.lesson-content :global(.code-block pre) {
		margin: 0;
	}

	.lesson-content :global(.copy-btn) {
		position: absolute;
		top: 8px;
		right: 8px;
		padding: 4px 10px;
	...
	.lesson-content :global(.copy-btn:hover) {
		color: var(--white);
