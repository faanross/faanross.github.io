---
layout: course01
title: "Lesson 7: Add DNS to Run Loop"
---
...
Let's undo the changes we made at the end of the last lab so that we once again use `RunLoop()`. Update `cmd/agent/main.go`:
