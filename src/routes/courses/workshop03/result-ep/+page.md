...
The starting solution can be found [here](https://github.com/faanross/workshop_antisyphon_23012026/tree/main/lesson_11_Begin).

The final solution can be found [here](https://github.com/faanross/workshop_antisyphon_23012026/tree/main/lesson_11_End).
...
In Lesson 8, we created `SendResult()` on the agent side:
...
First, let's register the endpoint in the server's `Start()` method. Update `server/server.go`:
